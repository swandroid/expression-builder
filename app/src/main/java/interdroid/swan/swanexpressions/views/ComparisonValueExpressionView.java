 ...
 */
public class ComparisonValueExpressionView extends FrameLayout {
    ...
    public ComparisonValueExpressionView(Context context) {
        super(context);
    }

    public ComparisonValueExpressionView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ComparisonValueExpressionView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void getViews() {
        mExpressionContainer = (LinearLayout) findViewById(R.id.logic_value_expression_container);
        mExpressionName = (TextView) findViewById(R.id.logic_value_expression_name);
    }
    ...
    private void addExpressionItems() {
        ...
        LayoutInflater inflater = LayoutInflater
                .from(getContext());
        List<ExpressionCreatorItem> items = ((ComparisonValueExpression) mExpressionCreatorItem.expressionInterface).getExpressionCreatorItems();
