...
import interdroid.swan.swanexpressions.activities.BuilderActivity;
 ...
 */
public class ExpressionCreatorListAdapter extends RecyclerView.Adapter<ExpressionCreatorListAdapter.SimpleViewHolder>
    ...
    public ExpressionCreatorListAdapter(Context context) {
        mContext = context;
...
//    }
    ...
    private void startExpresionSelectionActivity(ExpressionCreatorItem expressionCreatorItem) {
        ...
        ((Activity) mContext).startActivityForResult(intent, BuilderActivity.EXPRESSION_REQUEST_ID);
    }
